...
router.post('/', [authenticate, check('key').notEmpty().withMessage('key is required'), check('name').notEmpty().withMessage('name is required'), check('body').notEmpty().withMessage('body is required'), validate], ctrl.create);
